...
<body>
    ...
    <div class="sidenav">
        <div class="login-main-text text-center">
            ...
            <h1>PIICO</h1>
            <h3>Contactanos para conocer más del Proyecto</h3>
        </div>
    </div>
    <div class="main">
        <div class="col-md-6 col-sm-12">
            <div class="login-form">
                <form id="contactanos" class="contact" name="contactanos" method="post" action="enviar.php">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control mail-field" required="required" placeholder="Usuario">
                    </div>
                    <div class="form-group">
                        <label>Mensaje</label>
                        <textarea type="form-control" name="mensaje" id="mensaje" class="form-control" required="required" rows="8" placeholder="Mensaje"></textarea>
                    </div>
                    <button type="submit" class="btn btn-success text-white">Enviar</button>
                    <a type="button" class="btn btn-warning text-white" href="#">Cancelar</a>
                </form>
            </div>
            <hr>
        </div>
